...
insert into user_authentication(user_authentication_id, user_id, authentication_type, authentication_key, create_time, update_time)
    SELECT 1, 1, 'LOCAL', 'ea92f85e3bdee2c001444b6a86a7d7b30e2a4a4052606edfdc154492e8941d2c1e6824db3afb8cfd', (SYSDATE - DATE '1970-01-01') * 86400000, (SYSDATE - DATE '1970-01-01') * 86400000 from dual;
