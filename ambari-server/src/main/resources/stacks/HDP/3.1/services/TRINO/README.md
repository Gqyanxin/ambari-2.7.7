# ambari-trino-service [![BuildStatus](https://travis-ci.org/prestodb/ambari-presto-service.svg?branch=master)](https://travis-ci.org/prestodb/ambari-presto-service)
