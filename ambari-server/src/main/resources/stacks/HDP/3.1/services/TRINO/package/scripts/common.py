...
TRINO_RPM_URL = config.get('download', 'trino_rpm_url')
TRINO_RPM_NAME = config.get('download', 'trino_rpm_name')
#TRINO_RPM_NAME = TRINO_RPM_URL.split('/')[-1]
TRINO_CLI_URL = config.get('download', 'trino_cli_url')
